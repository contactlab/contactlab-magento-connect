...
/** Filter cart product number. */
class Contactlab_Template_Model_Newsletter_Processor_Filter_Cart_ProductNumber
        extends Contactlab_Template_Model_Newsletter_Processor_Filter_Abstract {

    /**
     * Apply filter to include only customers that have a product number > x into cart.
     *
    ...
    public function getName() {
        return "Filter cart by product number";
    }
}
